...
const CONTACT_CONFIG = {
  ...
  styling: {
    container:
      "lg:min-h-screen lg:mx-10 rounded-2xl flex items-center justify-center",
    gridLayout:
      "grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 bg-[var(--color-bg-secondary)]/30 backdrop-blur-lg rounded-3xl overflow-hidden shadow-2xl",
  },
  validation: {
    emailRegex: /\S+@\S+\.\S+/,
  },
        ...
        <div className={CONTACT_CONFIG.styling.gridLayout}>
          ...
          <div className="p-6 md:p-12 flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <input
                    ...
                    className={`w-full p-3 bg-[var(--color-bg-secondary)] text-[var(--color-text-primary)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] ${
                      errors.firstName ? "border-2 border-[var(--color-error)]" : ""
                    }`}
                  />
                  {errors.firstName && (
              ...
              />
              {errors.email && (
                <p className="text-[var(--color-error)] text-xs mt-1">{errors.email}</p>
              )}
              ...
              />
              {errors.message && (
                <p className="text-[var(--color-error)] text-xs mt-1">{errors.message}</p>
              )}
