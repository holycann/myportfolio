...
export const ContainerHoverAnimation = ({
  ...
  return (
    <div className="flex lg:items-start lg:justify-start sm:items-center sm:justify-center relative p-2 md:px-20 md:pb-20">
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[20rem] lg:h-[25rem] w-full border-4 border-[#6C6C6C] p-2 lg:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
