...
const CategoryTabs: React.FC<CategoryTabsProps> = ({
  ...
  useEffect(() => {
    ...
    const activeTab = tabsRef.current.querySelectorAll("li")[
      activeIndex
    ] as HTMLElement;
    if (activeTab) {
      updateEffectPosition(activeTab);
      textRef.current?.classList.add("active");
    }
    const resizeObserver = new ResizeObserver(() => {
      const currentActiveTab = tabsRef.current?.querySelectorAll("li")[
        activeIndex
      ] as HTMLElement;
      if (currentActiveTab) {
        updateEffectPosition(currentActiveTab);
      }
    });
  ...
  return (
    <>
      {/* Existing style tag remains the same */}
      <style>
        {`
          :root {
